...
class DashboardScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    dashboardController.initializeHomeGridItemList(userType);
        ...
        return LoadingContainerWidget(
          ...
          child: Scaffold(
            ...
            appBar: CustomAppBar(
              context,
              backgroundColor: AppColor.primaryColor,
              appBarType: userType == UserType.loggedInUser
                  ? AppBarType.loggedInType
                  : AppBarType.guestType,
              username:
                ...
                children: [
                  Container(
                    ...
                    child: GridView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount:
                          dashboardController.homeGridItemList.value.length,
                      itemBuilder: (context, index) {
                        return HomeGridItemWidget(
                          item:
                              dashboardController.homeGridItemList.value[index],
                          onTap: () {
                            switch (dashboardController
                                .homeGridItemList.value[index].type) {
                              case HomeGridItemType.forEnrollment:
                                context.push(AppScreen
                                    .registrationApplicationScreen.path);
                                break;
                              ...
                              case HomeGridItemType.study:
                                context.push(
                                  AppScreen.userDashboardScreen.path,
                                  extra: controller.userTypeData.value,
                                );
                                break;
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                      scrollDirection: Axis.horizontal,
                      itemCount:
                          dashboardController.certificateFormatList.length,
                      shrinkWrap: true,
                      itemBuilder: (context, index) {
                        return CertificateFormatItemWidget(
                          index: index,
                          item:
                              dashboardController.certificateFormatList[index],
                          onTap: () {
                            context.push(
